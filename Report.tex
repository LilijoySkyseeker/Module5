...
It will all be contained within a custom case that will be mouted to the wall.
The cameras will be POE IP cameras that will be connected to the switch and powered by it.
The customer will be able to pick various numbers and varioutions of inddoor and outdoor cameras.
...
The storage will be through AWS S3 mounted to localling using rclone.
...
The install service will be done by in house contratcors.
