...
\textbf{Hardware} &  &  &  \\
\hline
Assemble Pie box & Verify all components are present &  &  \\
\hline
 & Attach Raspberry Pi to the case &  &  \\
\hline
 & Attach Coral Accelerator to the Pi &  &  \\
\hline
 & Secure the POE switch in the case &  &  \\
\hline
Connect POE switch to power & Verify power adapter is connected &  &  \\
\hline
 & Verify POE switch is powered on &  &  \\
\hline
Connect Pie to power & Verify power adapter is connected &  &  \\
\hline
 & Verify Raspberry Pi is powered on &  &  \\
\hline
Connect Pie to switch & Connect Ethernet cable from Pi to switch &  &  \\
\hline
 & Verify network connection on Pi &  &  \\
\hline
Close enclosure & Verify all components are secured &  &  \\
\hline
 & Close and lock the enclosure &  &  \\
\hline
Connect cameras to switch & Connect Ethernet cables from cameras to switch &  &  \\
\hline
 & Verify cameras are powered on &  &  \\
\hline
Check that cameras are powered & Verify camera LEDs are on &  &  \\
\hline
\textbf{Software} &  &  &  \\
\hline
