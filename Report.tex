...
Assemble Pie box &  &  &  \\
\hline
Connect POE switch to power &  &  &  \\
\hline
Connect Pie to to power &  &  &  \\
\hline
Connect Pie to switch &  &  &  \\
\hline
Close enclosure &  &  &  \\
\hline
Connect cameras to switch &  &  &  \\
\hline
Check that cameras are powered &  &  &  \\
\hline
\textbf{Software} &  &  &  \\
\hline
Install preconfigured OS using flashdrive &  &  &  \\
\hline
Check that Frigate is running &  &  &  \\
\hline
Check that Rclone is running &  &  &  \\
\hline
Check that the bucket is mounted and viewable &  &  &  \\
\hline
Check that the web interface is viewable &  &  &  \\
\hline
\end{tabular}
